...
import { table as documentsTable } from '@/routes/documents/index/index';
...
const navigateToDocument = (id: number) => {
    router.visit(documentsRoutes.show(id).url);
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-4 p-4 md:p-6">
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                <Heading
                    title="Dokumenty - Widok tabeli"
                    description="Przegladaj dokumenty w widoku tabelarycznym."
                />
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead class="hidden md:table-cell">Numer</TableHead>
                                <TableHead class="hidden lg:table-cell">Wystawca</TableHead>
                                <TableHead class="hidden sm:table-cell">Kategoria</TableHead>
                                <TableHead class="hidden lg:table-cell">Segregator</TableHead>
                                <TableHead>Data</TableHead>
                                <TableHead class="text-right">Skany</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            <TableRow
                            ...
                            >
                                <TableCell class="w-10">
                                    <div class="size-8 rounded overflow-hidden bg-muted flex items-center justify-center">
                                        <img
                                ...
                                <TableCell class="hidden lg:table-cell">
                                    <div v-if="document.binder" class="flex items-center gap-1.5 text-muted-foreground">
                                        <FolderOpen class="size-3.5" />
                                        <span class="truncate max-w-[100px]">{{ document.binder.name }}</span>
                                    </div>
                                    <span v-else class="text-muted-foreground">Elektroniczny</span>
                                </TableCell>
